...
def plot_snp2(df, snp_plots=[], cov_plots=[], chroms='all', cov_offset=.25, cov_height=0.5, color_chroms=True, colormap='coolwarm_r', show_lines=True, region='', label_size=12, figsize=(20, 4), ylim=(-1, 1)):
