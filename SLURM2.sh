...
snakemake -s Snakefile2 --unlock --rerun-incomplete;
snakemake -s Snakefile2 --use-conda --rerun-incomplete --cluster-config config/cluster.json --drmaa "$DRMAA" -prk -j 1000;
