...
snakemake -s Snakefile1 --unlock --rerun-incomplete;
snakemake -s Snakefile1 --use-conda --rerun-incomplete --cluster-config config/cluster.json --drmaa "$DRMAA" -prk -j 1000;
